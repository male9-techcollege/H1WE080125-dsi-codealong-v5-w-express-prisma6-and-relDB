...
/* On Moodle, the code to copy and paste is in TypeScript. The extension of an interface is TypeScript as the following source shows.
...
export const authenticateTokenByMariePierreLessard = (req, res, next) => {
    ...
    */
    ...
    /* That format is to be set in Postman. See instructions on Moodle. */
