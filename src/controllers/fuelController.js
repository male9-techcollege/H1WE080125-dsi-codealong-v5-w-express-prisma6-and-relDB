...
export const getRecordsByMariePierreLessard = async (req, res) => {
    try {
        ...
        console.error(error);
        res.status(500).send(`DB Fejl: Kunne ikke hente liste af drivmidler`);
    };
};
...
export const getRecordByMariePierreLessard = async (req, res) => {
    ...
    try {
        ...
        console.error(error);
        res.status(500).json({ error: 'DB Fejl: Kunne ikke hente drivmiddel' });
    }
};
...
export const deleteRecordByMariePierreLessard = async (req, res) => {
    ...
    try {
        ...
        console.error(error);
        res.status(500).json({ error: 'Kunne ikke slette drivmidlet' });
    };
};
